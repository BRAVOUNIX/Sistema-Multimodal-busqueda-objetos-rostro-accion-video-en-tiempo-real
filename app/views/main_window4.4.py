...
from PyQt6.QtWidgets import (QMainWindow, QVBoxLayout, QWidget, QLabel, QMenuBar, 
                            QMenu, QDialog, QVBoxLayout, QLineEdit, QPushButton, 
...
class MainWindow(QMainWindow):
    def __init__(self, username, profile, db):
        super().__init__()
    ...
    def show_user_management(self):
        ...
        dialog = UserManagementDialog(user_controller, self)
        dialog.exec()
